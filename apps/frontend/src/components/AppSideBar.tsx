...
export default function AppSideBar({
  ...
  const [resolvedNavConfig, setResolvedNavConfig] =
    useState<NavbarConfig>(navConfig);
                  ...
                  <SidebarMenu className="gap-1.5">
                    {section.items
                      ...
                      .map((item: NavItem, itemIdx: number) => {
                        ...
                        const isActive =
                          hasHref && (pathname === item.href || isChildActive);
                    ...
                    <DropdownMenuGroup className="space-y-0.5">
                      ...
                      <DropdownMenuItem
                        ...
                        onSelect={(e) => {
                          e.preventDefault();
                          setBookmarkName(
                            document.title || "New Constellation",
                          );
                          const faviconEl =
