            ...
            >
              <div className="p-4 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {hasProgressOverride ? (
                    <div className="flex bg-zinc-950/40 border border-zinc-800/50 rounded-xl overflow-hidden focus-within:border-primary/50 transition-all duration-300 h-9 mt-1">
                      <Input
                        type="number"
                        min="0"
