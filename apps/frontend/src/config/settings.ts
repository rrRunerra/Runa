import { User, ShieldCheck, KeyRound, Mail, Link2, Lock, Smartphone, LucideIcon } from "lucide-react";
...
export const settingsNavConfig: SettingCategory[] = [
  ...
  { id: "mailAccounts", name: "Mail Accounts Settings", label: "Mail Accounts", badge: "Pegasus inbox linkings", icon: Mail },
